...
import MapsTemp from "@/components/MapsTemp";
import ChatBox from "@/components/ChatBox";
import Header from "@/components/HeaderScroll";
import Carousel from "@/components/Carousel";
import Evaluation from "@/components/Evaluation Section";
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
              O FitnessHub oferece um conjunto completo de ferramentas de gestão
              para otimizar a sua academia.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3  gap-8">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-slate-50 rounded-2xl p-8 shadow-sm border border-slate-100 flex flex-col items-center"
            >
              ...
              <p className="text-slate-600 text-center">
                Gerencie facilmente todas as aulas, horários e instrutores em um
                só lugar. Acompanhe a frequência e o progresso dos alunos.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 text-center">
                Mantenha todos informados com nosso sistema de mensagens
                integrado. Envie avisos, atualizações e feedback pessoal.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 text-center">
                Gestão de várias unidades da sua academia com facilidade. Tenha
                uma visão completa de todas as suas localizações.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
              Visite nossa unidade principal em Vila Real, Portugal. Estamos
              estrategicamente localizados para melhor atender nossos clientes.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <ChatBox
              ...
              onSendMessage={(message) => {
                // Aqui você pode implementar sua lógica personalizada
      ...
      <footer className="bg-slate-900 py-12 text-slate-400">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm">
              &copy; {new Date().getFullYear()} FitnessHub. Todos os direitos
              reservados.
            </p>
